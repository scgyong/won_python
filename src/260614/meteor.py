...
class Meteor:
    ...
    def __init__(self, x=None, y=None, dx=None, dy=None):
        if Meteor.image is None:
            ...
            Meteor.half_width = Meteor.image.get_width() // 2
            Meteor.half_height = Meteor.image.get_height() // 2
            Meteor.min_x = Meteor.half_width
            Meteor.max_x = cfg.screen_width - Meteor.half_width
            Meteor.min_y = Meteor.half_height
            Meteor.max_y = cfg.screen_height - Meteor.half_height
